...
descuento_total = 0
grupos = (len(precios) + n - 1) // n #determinar la cantidad de grupos necesarios y la cantidad de grupos en los cuales se aplicara un descuento.
...
if len(precios) < n:
    ...
    print(f"Precio final despues del descuento: {precio_final}")
